...
public class ActivityA extends ActionBarActivity {
    ...
    // Creamos una variable privada constante para poder utilizarla en clave/valor
    private final String DATA = "data";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_a); // Después de esta linea ya esta lista la interface
        ...
        Button btnOpenB = (Button)findViewById(R.id.btnOpenB); // Obtenemos la ref. del elemento
        Button btnClose = (Button)findViewById(R.id.btnClose);

        btnOpenB.setOnClickListener(new View.OnClickListener() { // Creamos un listener
            @Override
    ...
    // Normalmente haremos esto para recuperar el estado anterior de la app
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        String data = savedInstanceState.getString(DATA);
        Log.d(DATA, "ActivityA onRestoreInstanceState() saved data:" + data);
    ...
    protected void onStart() {
        ...
        * Log.d(tag, valor a mostrar)
        *
        * El tag sirve para poder buscar el mensaje en la consola
        * */
    ...
    // Nos permite guardar datos, nuestro estado
    @Override
